...
const createSubcategory = asyncHandler(async (req, res) => {
    ...
    res.status(201).json({success: true, data: newSubcategory, message: 'Subcategory created successfully'});
});
...
const subcategoryById = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({success: true, data: subcategoryData});
});
...
const updateSubcategory = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({success: true, data: updatedSubcategory, message: 'Subcategory updated successfully'});
});
...
const deleteSubcategory = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({success: true, message: 'Subcategory and all related data deleted successfully'});
});
